...
namespace Prisoners_Management_System.config
{
    internal class Internet
    {
        ...
        // sent feedback via email function 
        public void FeedBack(string code, string ToMailAddress)
        {
            try
            {
                ...
                message.Body = "<font>Roll Call Code : <strong>" + code + "</strong></font><br><br>";
                message.Body += "<font>All inmates where scanned successfully.</font><br><br>";
        ...
        public void RollCallFeedBack((string, DataSet) htmlString, string ToMailAddress)
        {
            try
            {
                string inmate = "";
                foreach (DataRow dataRow in htmlString.Item2.Tables["result"].Rows)
                {
                    ...
                    if (File.Exists(Path + "\\Face\\" + dataRow["code"].ToString() + ".bmp"))
                    {
                        var converter = new GroupDocs.Conversion.Converter(Path + "\\Face\\" + dataRow["code"].ToString() + ".bmp");
                        ...
                        inmate = "<font>Failed to Load Inmate Image</font><br><br>";
                    inmate += "<font>Inmate Code : <strong>" + dataRow["code"].ToString() + "</strong></font><br>";
                    inmate += "<font>Dormitory : <strong>" + Dormitory.GetName(Convert.ToInt32(dataRow["dormitory_id"])) + "</strong></font><br>";
                    inmate += "<font>Fullname : <strong>" + dataRow["last_name"].ToString() + ", " + dataRow["first_name"].ToString() + " " + dataRow["middle_name"].ToString() + "</strong></font><br>";
                    inmate += "<font>Gender : <strong>" + dataRow["gender"].ToString() + "</strong></font><br>";
                    inmate += "<font>Date of Birth : <strong>" + Convert.ToDateTime(dataRow["dob"]).ToString("dd/MM/yyyy") + "</strong></font><br>";
                    inmate += "<font>Address : <strong>" + dataRow["address"].ToString() + "</strong></font><br>";
                    inmate += "<font>Marital Status : <strong>" + dataRow["marital_status"].ToString() + "</strong></font><br>";
                    inmate += "<font>Eye Color : <strong>" + dataRow["eye_color"].ToString() + "</strong></font><br>";
                    inmate += "<font>Complexion : <strong>" + dataRow["complexion"].ToString() + "</strong></font><br>";
                    bool Isfirst = true;
                    string crimes = "";
                    ...
                    if (dsCrimesCommitted != null)
                        foreach (DataRow data in dsCrimesCommitted.Tables["result"].Rows)
                        {
                            if (Convert.ToInt32(dataRow["id"]) == Convert.ToInt32(data["inmate_id"]))
                            {
                                if (Isfirst)
                                {
                                    crimes = data["name"].ToString();
                                    Isfirst = false;
                                }
                                else
                                    crimes = crimes + ", " + data["name"].ToString();
                            }
                        }
                    ...
                    inmate += "<font>Emergency Name : <strong>" + dataRow["emergency_name"].ToString() + "</strong></font><br>";
                    inmate += "<font>Emergency Contact : <strong>" + dataRow["emergency_contact"].ToString() + "</strong></font><br>";
                    inmate += "<font>Emergency Relation : <strong>" + dataRow["emergency_relation"].ToString() + "</strong></font><br>";
                }
                MailMessage message = new MailMessage();
                SmtpClient smtp = new SmtpClient();
                message.From = new MailAddress(Resources.SenderEmail);
