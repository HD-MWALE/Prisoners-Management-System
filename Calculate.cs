        ...
        public static string Sentence(DateTimePicker Start, DateTimePicker End)
        {
            ...
            if (mouths.ToString().Contains("-"))
            {
                ...
                if (days.ToString().Contains("-"))
                {
                    ...
                    if (days != 0) sentence += "and " + (Config.MonthDays(Start.Value.Month) + days) + " day" + plural;
                }
                else
                {
                    if (mouths != 0)
            ...
            else if (days.ToString().Contains("-"))
            {
                ...
                if (days == 1) plural = ""; else plural = "s";
                if (days != 0)
                    if(mouths != 0) sentence += "and " + (Config.MonthDays(Start.Value.Month) + days) + " day" + plural;
                    else sentence += (Config.MonthDays(Start.Value.Month) + days) + " day" + plural;
